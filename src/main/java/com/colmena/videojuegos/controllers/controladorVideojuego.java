...
public class controladorVideojuego {
    ...
    //@PostMapping("/formulario/videojuego/0{id}")
    public String guardarVideojuego(
        ...
        try {
            ...
            // Si viene un archivo nuevo lo procesamos
            if (!archivo.isEmpty()) {
                ...
                videojuego.setImagen(nombreFoto); // seteo nueva imagen
            }

            // save() actualiza si el id != null y existe, inserta si es null
